...
public class PoolManager : SingletonMonobehavior<PoolManager>
{
    ...
    /// <summary>
    /// Reuse a gameobject component in the pool. 'prefab; is the prefab gameobject containint the component. 'position' is the world position for
    /// the game object where it should appear when enabled. 'rotation' should be set if the gameobject needs to be rotated.
    /// </summary>
    ...
    /// <summary>
    /// Get a gameobject compononet from thepool using the 'poolkey'
    /// </summary>
